...
public class Reservas {
    ...
    public Reservas(int codigo, String fecha, byte numeroNoches, byte numeroHuespedes,
    ...
    public byte getNumeroHuespedes() { return numeroHuespedes;
    }
    public void setNumeroHuespedes(byte numeroHuespedes) { this.numeroHuespedes = numeroHuespedes;
    }
    ...
    public short getPagoTotal() { return pagoTotal;
    }
    public void setPagoTotal(short pagoTotal) { this.pagoTotal = pagoTotal;
    }
